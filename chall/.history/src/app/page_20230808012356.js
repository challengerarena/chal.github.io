    ...
    <div className="content blog-layout--style-1">
      <article className="post has-post-thumbnail ">
        <div className="post__thumbnail">
          <a href="blog-post.html"><Image src="./assets/img/samples/news-v1-post-img-01.jpg"
  alt="Oyuncu Fotoğrafı"
  width={500} // Görüntünün genişliği
  height={300} /></a>
        </div>
      ...
      <article className="post has-post-thumbnail ">
        <div className="post__thumbnail">
          <a href="blog-post.html"><Image src="./assets/img/samples/news-v1-post-img-02.jpg"
  alt="Oyuncu Fotoğrafı"
  width={500} // Görüntünün genişliği
  height={300} /></a>
        </div>
      ...
      <article className="post has-post-thumbnail ">
        <div className="post__thumbnail">
          <a href="blog-post.html"><Image src="./assets/img/samples/news-v1-post-img-03.jpg"
  alt="Oyuncu Fotoğrafı"
  width={500} // Görüntünün genişliği
  height={300} /></a>
        </div>
      ...
      <article className="post has-post-thumbnail ">
        <div className="post__thumbnail">
          <a href="blog-post.html"><Image src="./assets/img/samples/news-v1-post-img-04.jpg"
  alt="Oyuncu Fotoğrafı"
  width={500} // Görüntünün genişliği
  height={300} /></a>
        </div>
      ...
      <article className="post has-post-thumbnail  post--video">
        <div className="post__thumbnail">
          <a href="https://www.youtube.com/watch?v=XE0fU9PCrWE" className="mp_iframe">
            <Image src="./assets/img/samples/news-v4-post-img-04.jpg"
  alt="Oyuncu Fotoğrafı"
  width={500} // Görüntünün genişliği
  height={300} />
      ...
      <article className="post has-post-thumbnail ">
        <div className="post__thumbnail">
          <a href="blog-post.html"><Image src="./assets/img/samples/news-v4-post-img-06.jpg"
  alt="Oyuncu Fotoğrafı"
  width={500} // Görüntünün genişliği
  height={300} /></a>
        </div>
