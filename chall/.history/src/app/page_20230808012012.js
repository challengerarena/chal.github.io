      ...
      <div className="widget widget-carousel slick-slider">
        <article className="widget-carousel__item player bg-image bg--ph-03">
          ...
          <div className="player__thumbnail">
            <Image src="assets/img/samples/team-info-page-player-photo-03.png" alt="" />
        ...
        <article className="widget-carousel__item player bg-image bg--ph-05">
          ...
          <div className="player__thumbnail">
            <Image src="assets/img/samples/team-info-page-player-photo-04.png" alt="" />
        ...
        <article className="widget-carousel__item player bg-image bg--ph-06">
          ...
          <div className="player__thumbnail">
            <Image src="assets/img/samples/team-info-page-player-photo-02.png" alt="" />
    ...
    <div className="content blog-layout--style-1">
      <article className="post has-post-thumbnail ">
        <div className="post__thumbnail">
          <a href="blog-post.html"><Image src="assets/img/samples/news-v1-post-img-01.jpg" alt="" /></a>
        </div>
      ...
      <article className="post has-post-thumbnail ">
        <div className="post__thumbnail">
          <a href="blog-post.html"><Image src="assets/img/samples/news-v1-post-img-02.jpg" alt="" /></a>
        </div>
        <div className="post__body">
          <div className="post__header">
            <ul className="post__cats list-unstyled">
      ...
      <article className="post has-post-thumbnail ">
        <div className="post__thumbnail">
          <a href="blog-post.html"><Image src="assets/img/samples/news-v1-post-img-03.jpg" alt="" /></a>
        </div>
        <div className="post__body">
          <div className="post__header">
            <ul className="post__cats list-unstyled">
      ...
      <article className="post has-post-thumbnail ">
        <div className="post__thumbnail">
          <a href="blog-post.html"><Image src="assets/img/samples/news-v1-post-img-04.jpg" alt="" /></a>
        </div>
        <div className="post__body">
          <div className="post__header">
            <ul className="post__cats list-unstyled">
      ...
      <article className="post has-post-thumbnail  post--video">
        <div className="post__thumbnail">
          <a href="https://www.youtube.com/watch?v=XE0fU9PCrWE" className="mp_iframe">
            <Image src="assets/img/samples/news-v4-post-img-04.jpg" alt="" />
      ...
      <article className="post has-post-thumbnail ">
        <div className="post__thumbnail">
          <a href="blog-post.html"><Image src="assets/img/samples/news-v4-post-img-06.jpg" alt="" /></a>
        </div>
        <div className="post__body">
          <div className="post__header">
            <ul className="post__cats list-unstyled">
