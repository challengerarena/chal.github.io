...
export default function Home() {
  ...
  height={300}/img/samples/team-info-page-player-photo-03.png"
  alt="Oyuncu Fotoğrafı"
  width={500} // Görüntünün genişliği
  height={300} />
  ...
  alt="Oyuncu Fotoğrafı"
  width={500} // Görüntünün genişliği
  height={300}/img/samples/team-info-page-player-photo-04.png"
  alt="Oyuncu Fotoğrafı"
  width={500} // Görüntünün genişliği
  height={300} />
  ...
  alt="Oyuncu Fotoğrafı"
  width={500} // Görüntünün genişliği
  height={300}/img/samples/team-info-page-player-photo-02.png"
  alt="Oyuncu Fotoğrafı"
  width={500} // Görüntünün genişliği
  height={300} />
    ...
    <div className="content blog-layout--style-1">
      <article className="post has-post-thumbnail ">
        <div className="post__thumbnail">
          <a href="blog-post.html"><Image src="jpg"
  alt="Oyuncu Fotoğrafı"
  width={500} // Görüntünün genişliği
  height={300}/img/samples/news-v1-post-img-01.jpg"
  alt="Oyuncu Fotoğrafı"
  width={500} // Görüntünün genişliği
  height={300} /></a>
        </div>
  ...
  alt="Oyuncu Fotoğrafı"
  width={500} // Görüntünün genişliği
  height={300}/img/samples/news-v1-post-img-02.jpg"
  alt="Oyuncu Fotoğrafı"
  width={500} // Görüntünün genişliği
  height={300} /></a>
        </div>
  ...
  alt="Oyuncu Fotoğrafı"
  width={500} // Görüntünün genişliği
  height={300}/img/samples/news-v1-post-img-03.jpg"
  alt="Oyuncu Fotoğrafı"
  width={500} // Görüntünün genişliği
  height={300} /></a>
        </div>
  ...
  alt="Oyuncu Fotoğrafı"
  width={500} // Görüntünün genişliği
  height={300}/img/samples/news-v1-post-img-04.jpg"
  alt="Oyuncu Fotoğrafı"
  width={500} // Görüntünün genişliği
  height={300} /></a>
        </div>
  ...
  alt="Oyuncu Fotoğrafı"
  width={500} // Görüntünün genişliği
  height={300}/img/samples/news-v4-post-img-04.jpg"
  alt="Oyuncu Fotoğrafı"
  width={500} // Görüntünün genişliği
  height={300} />
  ...
  alt="Oyuncu Fotoğrafı"
  width={500} // Görüntünün genişliği
  height={300}/img/samples/news-v4-post-img-06.jpg"
  alt="Oyuncu Fotoğrafı"
  width={500} // Görüntünün genişliği
  height={300} /></a>
        </div>
